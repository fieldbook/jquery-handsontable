describe('WalkontableScrollbar', function () {
  ...
  xit("should keep a consistent size of the vertical scroll handle, when cells heights differ", function () {
    this.data = [
  ...
  xit("should keep a consistent size of the horizontal scroll handle, when cells heights differ", function () {
    this.data = [
    ...
    var initialScrollHandleWidth = handle.width();
    expect(initialScrollHandleWidth).toBeGreaterThan(0);

    var currentScrollHandleWidth;

    wt.scrollHorizontal(1);
    wt.draw();
    currentScrollHandleWidth = handle.width();
    expect(currentScrollHandleWidth).toEqual(initialScrollHandleWidth);
